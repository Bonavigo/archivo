...
class HomeController extends RenderView
{
	...
	public function index()
	{
		$this->loadView('pages/partials/header', [
			"title" => "Projeto Archivo"
		]);
		$this->loadView('pages/inicial', []);
		/*$this->loadView('pages/partials/header', [
			"title" => "Home Page",
			'isAuth' => $auth,
			'user' => $user
	...
	{
		$this->loadView('pages/partials/header', [
			"title" => "Projeto Archivo - Igrejas"
		]);
		$this->loadView('pages/igrejas', []);
		$this->loadView('pages/partials/footer', []);
	}

	public function ferrovias()
	{
		$this->loadView('pages/partials/header', [
			"title" => "Projeto Archivo - Ferrovias"
		]);
		$this->loadView('pages/ferrovias', []);
		$this->loadView('pages/partials/footer', []);
	}
